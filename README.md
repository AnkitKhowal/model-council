...
The gateway evaluation suite adds 30 versioned technical, writing, analysis, explanation, general, and adversarial routing cases. It measures contract validity, verified-ID compliance, task and complexity accuracy, expected-capability Hit@3, provider diversity, and p50/p95 routing latency. The checked-in fixture scorecard is at [`evals/results/gateway-scorecard-fixture.md`](evals/results/gateway-scorecard-fixture.md), the production improvement is summarized in the [`before/after report`](evals/results/gateway-scorecard-comparison.md), and the complete methodology and opt-in live/blinded outcome commands are in [`docs/gateway-evaluations.md`](docs/gateway-evaluations.md).
